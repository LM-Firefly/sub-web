<template>
  <div>
      ...
      <el-col>
        <el-card>
          <template #header>
            ...
            <icon-github style="margin-left: 20px; width: 1em; height: 1em;" @click=" goToProject " />
            <icon-telegram style="margin-left: 20px; width: 1em; height: 1em;" @click=" gotoTgChannel " />
            <icon-clash style="margin-left: 20px; width: 1em; height: 1em;" @click=" gotoGayhubRuleset " />
            ...
            <el-form :model=" form " label-width="90px" label-position="left"
              ...
              <el-form-item label="远程配置:">
                <el-select v-model=" form.remoteConfig " style="width: 100%" allow-create filterable
                  ...
                  <template #append>
                    <el-link @click=" gotoRemoteConfig "><el-icon>
                        <InfoFilled />
              ...
              <el-form-item label="后端地址:">
                <el-select v-model=" form.customBackend " style="width: 100%" allow-create filterable>
                  <template #append>
                    <el-link @click=" gotoGayhub "><el-icon>
                        <InfoFilled />
              ...
              <el-form-item label="定制订阅:" label-width="90px" label-position="left" style="width: 100%">
                <el-input class="copy-content" disabled v-model=" customSubUrl ">
                  <template #append>
                    <el-button @click="makeUrl()" v-clipboard:copy=" customSubUrl " v-clipboard:success=" onCopy "
                      ref="copy-btn"><el-icon>
                        <DocumentCopy />
    ...
    <el-dialog v-model=" dialogLoadConfigVisible " :show-close=" false " :close-on-click-modal=" false "
      ...
      <template #title>可以从老的订阅信息中解析信息,填入页面中去</template>
...
<script>
  ...
  const gayhubSource = import.meta.env.VITE_APP_BACKEND;
  const gayhubRuleset = import.meta.env.VITE_APP_RULESET_LINK;
