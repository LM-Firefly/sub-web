            ...
            <el-form :model=" form " label-width="80px" label-position="left" style="width: 100%">
              ...
              <el-form-item label="远程配置:">
                <el-select v-model=" form.remoteConfig " style="width: 100%" allow-create filterable
                  ...
                  <el-option-group v-for="                      group in options.remoteConfig                      "
    ...
    var data = {
      ...
      options: {
        ...
        backendOptions: [
          ...
          { value: "https://fly-sub.fly.dev/sub?" },
          { value: "https://sub.koyeb.app/sub?" },
          { value: "https://render-sub.onrender.com/sub?" },
          { value: "https://subs-fireflylzh.b4a.run/sub?" },
          { value: "https://flysub.firefly-lm.workers.dev/sub?" },
          { value: "https://sub.firefly-lm.workers.dev/sub?" },
          { value: "https://rensub.firefly-lm.workers.dev/sub?" },
          { value: "https://subs.firefly-lm.workers.dev/sub?" },
        ],
        remoteConfig: [
          {
            label: "默认",
    ...
    makeUrl ()
    {
      ...
      if ( this.advanced === "2" )
      {
        ...
        if ( this.form.clientType === "clash" )
        {
          ...
          {
            this.customSubUrl += "&clash.dns=" + encodeURIComponent( this.form.clashdns );
          }
        }
