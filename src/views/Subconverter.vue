            ...
            <el-form :model="form" label-width="90px" label-position="left" style="width: 100%; align-content: center;"
              ...
              <el-form-item label="远程配置:">
                <el-select v-model="form.remoteConfig" style="width: 100%" allow-create filterable
                  ...
                  <template #footer>
                    <el-link @click="gotoRemoteConfig" style="margin-left: 20px"><el-icon>
                        <InfoFilled />
              ...
              <el-form-item label="后端地址:">
                <el-select v-model="form.customBackend" style="width: 100%" allow-create filterable>
                  <template #footer>
                    <el-link @click="gotoGayhub" style="margin-left: 20px"><el-icon>
                        <InfoFilled />
              ...
              <div v-if="advanced === '2'">
                ...
                <el-form-item label="Clash.TUN:" v-if="isClash">
                ...
                <el-form-item label="远程设备:" v-if="isQuanX">
                ...
                <el-form-item style="width: 100%; text-align: center" label-width="0px">
                  <el-row justify="center">
                    <el-button-group>
                      <el-popover placement="bottom" v-model:visible="globalOptionsVisible"
                        style="text-align: center; min-width: 600px;">
                        <el-row :gutter="10">
                          <el-checkbox v-if="isClash" v-model="form.new_name" label="Clash新字段"></el-checkbox>
                          <el-checkbox v-model="form.emoji" label="Emoji"></el-checkbox>
                          <el-checkbox v-model="form.appendType" label="节点类型"></el-checkbox>
                          <el-checkbox v-model="form.sort" label="排序节点"></el-checkbox>
                          <el-checkbox v-model="form.fdn" label="过滤非法节点"></el-checkbox>
                          <el-checkbox v-if="!isSimpleTarget" v-model="form.nodeList" label="输出为 Node List"></el-checkbox>
                      ...
                      <el-popover placement="bottom" v-model:visible="nodeOptionsVisible"
                        style="text-align: center; min-width: 600px;">
                        <el-row :gutter="10">
                      ...
                      <el-popover placement="bottom" v-model:visible="ruleVisible"
                        style="text-align: center; min-width: 200px;">
                        <el-row :gutter="10">
                          <el-checkbox v-model="form.expand" :disabled="form.classic" label="展开规则"></el-checkbox>
                        </el-row>
                        <el-row :gutter="10">
                          <el-checkbox v-model="form.classic" label="Domain-Set Rules (Clash/Surge)"
...
// Target categorization for conditional UI
const SIMPLE_TARGETS = new Set(['ss', 'ssd', 'ssr', 'sssub', 'v2ray', 'trojan', 'mixed']);
const target = computed(() => form.clientType?.target || '');
const isSimpleTarget = computed(() => SIMPLE_TARGETS.has(target.value));
const isClash = computed(() => target.value === 'clash');
const isQuanX = computed(() => target.value === 'quanx');
...
const validateAgekey = () => {
  if (!form.agekey) return;
  if (!/^AGE-SECRET-KEY-(?:PQ-)?1[0-9A-Z]+$/.test(form.agekey)) {
    ElMessage.error("输入的 agekey 不符合 mihomo 规范");
    form.agekey = "";
  }
};
