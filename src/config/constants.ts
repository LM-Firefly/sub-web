// 后端配置选项
export const customBackendDirectives = {
  ...
  "zeasub.zeabur.app/sub?": "https://zeasub.zeabur.app/sub?",
  ...
  "zeasub.firefly-lm.workers.dev/sub?": "https://zeasub.firefly-lm.workers.dev/sub?",
  "rensub.firefly-lm.workers.dev/sub?": "https://rensub.firefly-lm.workers.dev/sub?",
};

export const clashDnsOptions = {
  "默认不开启TUN/TAP": "",
  tap: "tap",
  "win-tun": "win-tun",
  "linux-tun": "linux-tun",
